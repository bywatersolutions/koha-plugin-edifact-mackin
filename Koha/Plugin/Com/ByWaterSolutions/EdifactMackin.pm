package Koha::Plugin::Com::ByWaterSolutions::EdifactMackin;
...
our $metadata = {
    name            => 'Edifact - Mackin',
    author          => 'Kyle M Hall',
    description     => 'Edifact plugin for Mackin',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactMackin::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactMackin::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactMackin::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactMackin::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactMackin::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
